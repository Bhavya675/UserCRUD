...
async Task Demo()
{
    ...
    car.Reset();
    car.Refuel(1);
    // car.Category  // Encapsulation: Here it denies access to the private variable of the parent class because the property is private
    Console.WriteLine(car.GetFuelLevel());
    Inventory inventory = new Inventory(); // Object Creation
    InventoryDetails inventoryDetails = new InventoryDetails();
    Vehicle vehicle = new Vehicle();
    vehicle.StartVehicle();
    inventoryDetails.Start();
    inventory.GetInventory(150); // Called base method
    inventoryDetails.GetInventory(150); // Called overriden method
    // switch(car.GetFuelLevel()){
    //     case 100:
    //     System.Console.WriteLine("Fuel is full");
    //     break;
    // }
}
